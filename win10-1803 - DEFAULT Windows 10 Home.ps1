...
Set-Service "AssignedAccessManagerSvc" -StartupType Not Available 
...
Set-Service "CaptureService_?????" -StartupType Not Available 
...
Set-Service "DevicePickerUserSvc_27845" -StartupType Manual 
...
Set-Service "BcastDVRUserService_?????" -StartupType Manual 
...
Set-Service "hns" -StartupType Not Available 
...
Set-Service "vmcompute" -StartupType Not Available 
...
Set-Service "vmms" -StartupType Not Available 
...
Set-Service "AppVClient" -StartupType Not Available 
...
Set-Service "WmsRepair" -StartupType Not Available 
Set-Service "Wms" -StartupType Not Available 
...
Set-Service "UwfServcingSvc" -StartupType Not Available 
...
Set-Service "UevAgentService" -StartupType Not Available 
...
Set-Service "Sense" -StartupType Not Available 
...
Set-Service "WpnUserService_?????" -StartupType Automatic 
